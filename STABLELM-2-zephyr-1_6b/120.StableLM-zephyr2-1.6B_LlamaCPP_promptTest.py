...
# MODEL: https://huggingface.co/afrideva/stablelm-2-zephyr-1_6b-GGUF/tree/main
# stablelm-2-zephyr-1_6b.q6_k.gguf
import sys
...
stops = ['<|endoftext|>']
tasks = createCatalog()
modelname = 'stablelm-2-zephyr-1_6b.q6_k.gguf'
# create THE LOG FILE 
coded5 = genRANstring(5)
logfile = f'logs/stablelm-2-zephyr-1_6b_CPP_{coded5}_log.txt'
csvfile = f'logs/stablelm-2-zephyr-1_6b_CPP_{coded5}.csv'
logfilename = logfile
...
##############MODEL CARD##########################################
"""
afrideva-stablelm-2-zephyr-1_6b-GGUF at main
https://huggingface.co/afrideva/stablelm-2-zephyr-1_6b-GGUF/tree/main
>>> from llama_cpp import Llama
>>> llm = Llama(model_path='models/stablelm-2-zephyr-1_6b.q6_k.gguf')
---------------------------------------------------------------------------------------

0:                       general.architecture str              = stablelm
1:                               general.name str              = stablelm-2-zephyr-1_6b
2:                    stablelm.context_length u32              = 4096
3:                  stablelm.embedding_length u32              = 2048
4:                       stablelm.block_count u32              = 24
...
llm_load_print_meta: model size       = 1.26 GiB (6.57 BPW)
