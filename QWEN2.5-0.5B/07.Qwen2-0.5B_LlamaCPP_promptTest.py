...
# create THE LOG FILE 
logfile = f'logs/Qwen2-0.5B-it_CPP_{genRANstring(5)}_log.txt'
csvfile = f'logs/Qwen2-0.5B-it_CPP_{genRANstring(5)}.csv'
logfilename = logfile
...
df = pd.DataFrame(zipped, columns=['#', 'TASK', 'VOTE','REMARKS'])
