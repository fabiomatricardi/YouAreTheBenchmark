...
# MODEL: https://huggingface.co/MaziyarPanahi/SmolLM-1.7B-Instruct-GGUF/tree/main
...
stops = ['<|im_end|>']
tasks = createCatalog()
modelname = 'SmolLM-1.7B-Instruct.Q6_K.gguf'
# create THE LOG FILE 
coded5 = genRANstring(5)
logfile = f'logs/SmolLM-1.7B-Instruct_CPP_{coded5}_log.txt'
csvfile = f'logs/SmolLM-1.7B-Instruct_CPP_{coded5}.csv'
logfilename = logfile
...
# SmolLM-1.7B-Instruct.Q6_K.gguf
>>> from llama_cpp import Llama
>>> llm = Llama(model_path='models/SmolLM-1.7B-Instruct.Q6_K.gguf')
---------------------------------------------------------------------------------------
general.architecture str              = llama
        general.type str              = model
        general.name str              = Cosmo2 1.7B Webinst Sc2
...
ama.embedding_length u32              = 2048
.feed_forward_length u32              = 8192
llm_load_print_meta: model type       = ?B
llm_load_print_meta: model ftype      = Q6_K
llm_load_print_meta: model params     = 1.71 B
llm_load_print_meta: model size       = 1.31 GiB (6.56 BPW)
