...
# original https://huggingface.co/arcee-ai/arcee-lite 
# MODEL: https://huggingface.co/arcee-ai/arcee-lite-GGUF
# models/arcee-lite-Q5_K_M.gguf
import sys
...
stops = ['<|im_end|>']
tasks = createCatalog()
modelname = 'arcee-lite-Q5_K_M.gguf'
# create THE LOG FILE 
coded5 = genRANstring(5)
logfile = f'logs/arcee-lite_CPP_{coded5}_log.txt'
csvfile = f'logs/arcee-lite_CPP_{coded5}.csv'
logfilename = logfile
