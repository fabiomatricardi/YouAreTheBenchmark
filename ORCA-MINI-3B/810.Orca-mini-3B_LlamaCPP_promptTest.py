...
import datetime
from promptLibv3Alpaca import countTokens, writehistory, createCatalog
from promptLibv3Alpaca import genRANstring, createStats
import argparse
...
print("\033[92;1m")
stats = createStats(delta,instruction,output,rating,logfilename,'Alignment Generation',ttftoken)
print(stats)
...
-------------------------------------------
repo: https://huggingface.co/FM-1976/gemma-2-2b-it-Q5_K_M-GGUF · Hugging Face
