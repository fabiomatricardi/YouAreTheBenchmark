...
- say 'I am ready'
- modified for Orca-mini-3B prompt format 
Prompt format source: https://huggingface.co/pankajmathur/orca_mini_3b

If there is a context it goes in the {context} placeholder as part of the INPUT section
prompt = f"### System:\n{system}\n\n### User:\n{instruction}\n\n### Input:\n{context}\n\n### Response:\n"
prompt = f"### System:\n{system}\n\n### User:\n{instruction}\n\n### Response:\n"
20241020 FAMA
"""
