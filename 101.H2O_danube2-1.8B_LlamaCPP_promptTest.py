...
# MODEL: https://huggingface.co/h2oai/h2o-danube2-1.8b-chat-GGUF
...
stops = ['</s>']
tasks = createCatalog()
modelname = 'h2o-danube2-1.8b-chat-Q6_K.gguf'
# create THE LOG FILE 
coded5 = genRANstring(5)
logfile = f'logs/h2o-danube2-1.8b-chat_CPP_{coded5}_log.txt'
csvfile = f'logs/h2o-danube2-1.8b-chat_CPP_{coded5}.csv'
logfilename = logfile
...
##############MODEL CARD##########################################
"""
https://huggingface.co/h2oai/h2o-danube2-1.8b-chat-GGUF
model_path='models/h2o-danube2-1.8b-chat-Q6_K.gguf'
CHAT TEMPLATE = YES
...
llm_load_print_meta: model params     = 1.83 B
llm_load_print_meta: model size       = 1.40 GiB (6.56 BPW)
llm_load_print_meta: general.name     = h2o-danube2-1.8b-chat
